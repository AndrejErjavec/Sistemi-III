...
QPostNovica=()=>{
   axios.post("http://88.200.63.148:5056/novice", 
   {
 ...
 render(){
    ...
    return(
         ...
         <div className="card" style={{margin:"10px"}}>
            ...
            <input onChange={(e)=>this.QGetTextFromField(e)} name="title" type="text" class="form-control"  placeholder="Title..."/>
            </div>
            <div className="mb-3" style={{margin:"10px"}}>
            <label  className="form-label">Slug</label>
            <input onChange={(e)=>this.QGetTextFromField(e)} name="slug" type="text" class="form-control"  placeholder="Slug..."/>
            </div>
            <div class="mb-3" style={{margin:"10px"}}>
            <label  class="form-label">Text</label>
            <textarea onChange={(e)=>this.QGetTextFromField(e)} name="text" class="form-control" rows="3"></textarea>
            </div>
